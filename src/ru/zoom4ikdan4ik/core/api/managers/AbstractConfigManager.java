...
public abstract class AbstractConfigManager implements IConfigManager, IBase {
    ...
    public final String getString(String path, String option) {
        ...
        return this.getConfig().getString(this.getPath(CategoriesEnum.CONFIG, path));
    }
    ...
    public final int getInt(String path, int option) {
        ...
        return this.getConfig().getInt(this.getPath(CategoriesEnum.CONFIG, path));
    }
    ...
    public final boolean getBoolean(String path, boolean option) {
        ...
        return this.getConfig().getBoolean(this.getPath(CategoriesEnum.CONFIG, path));
    }
    ...
    public final double getDouble(String path, double option) {
        ...
        return this.getConfig().getDouble(this.getPath(CategoriesEnum.CONFIG, path));
    }

    public final long getLong(String path) {
        return this.getConfig().getLong(this.getPath(CategoriesEnum.CONFIG, path));
    }
    ...
    public final List<String> getStringList(String path) {
        return this.getConfig().getStringList(this.getPath(CategoriesEnum.CONFIG, path));
    }
    ...
    public final List<?> getList(String path, List<?> option) {
        ...
        return this.getConfig().getList(this.getPath(CategoriesEnum.CONFIG, path));
    }
    ...
    public final ConfigurationSection getConfigurationSection(String path) {
        return this.getConfig().getConfigurationSection(this.getPath(CategoriesEnum.CONFIG, path));
    }
